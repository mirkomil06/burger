...
function extra() {
    ...
    } else if (headerTimerExtra.innerHTML < 90) {
        headerTimerExtra.innerHTML++
        setTimeout(() => {
            extra()
        }, 100)
...
const mainProductImg = document.querySelectorAll('.main__product-info')
...
for (let i = 0; i < mainProductImg.length; i++) {
    mainProductImg[i].addEventListener('click', function () {
        img(this)
